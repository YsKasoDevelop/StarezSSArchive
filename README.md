...
配布物は[v1.01リリースページ](https://github.com/YsKasoDevelop/StarezSSArchive/releases/tag/v1.01)からダウンロードできます。ZIPをすべて展開し、フォルダ内の`StarezSSArchive.exe`を起動してください。.NETランタイムの別途インストールは不要です。
